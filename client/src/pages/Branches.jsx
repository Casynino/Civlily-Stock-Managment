        ...
        <div className="grid">
            <div className="card">
                <div className="sectionHeader">
                    ...
                    <button className="button" type="button" onClick={openCreate}>+ New Branch</button>
                </div>
                            ...
                            <tr key={b.id}>
                                ...
                                <td>
                                    <div className="tableActions">
                                        <button className="button" type="button" onClick={() => openEdit(b.id)}>
                                            Edit
                                        </button>
                                        <button className="button" type="button" onClick={() => openDelete(b.id)} style={{ background: 'rgba(214,69,93,0.10)' }}>
                                            Delete
                                        </button>
                                    </div>
                                </td>
